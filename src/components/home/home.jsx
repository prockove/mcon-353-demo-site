      ...
      >
        ...
        >
          ...
          <CardContent>
            ...
            >
              My name is Penina Rockove and I am currently pursuing a bachelors
              degree in Computer Science. This is my first REACT project!
            </Typography>
          </CardContent>
        </Card>
        ...
        >
          <CardMedia sx={{ height: "6rem", width: "19rem" }} image={eduImg} />
          <CardContent>
        ...
        >
          ...
          <Typography variant="h6" sx={{ m: 1 }}>
            <ArrowForwardIcon fontSize="small" /> Lifeguard at Twin Oaks and
            Luxor Estates
          </Typography>
          <Typography variant="h6" sx={{ m: 1 }}>
            <ArrowForwardIcon fontSize="small" /> Secretary at Yeshiva Ketana of
            Queens
          </Typography>
        </Card>
      </Grid>
